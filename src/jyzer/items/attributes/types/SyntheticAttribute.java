 ...
 * ClassFile, field_info, and method_info (§4.7) structures. A
...
public final class SyntheticAttribute extends AttributeInfo {
	 ...
	 */
	public SyntheticAttribute(DataInput di, int attributeNameIndex, int attributeLength) throws IOException {
		// SEM !!!
	...
	public void getHTMLDescription(StringBuilder sb) {
		sb.append("<B>Synthetic Attribute</B><BR>");
	}

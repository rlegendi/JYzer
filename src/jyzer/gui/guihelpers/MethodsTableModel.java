...
/**
 * The table model that is used by the methods pane.
 *
...
public class MethodsTableModel extends AbstractTableModel {
	...
	/**
	 * Creates a new model with the given data in it. The <code>MethodInfo</code>s
	 * are needed to display the method attributes.
	 *
	 * @param methods an array of the methodinfos.
	 * @param data the objects that has to be displayed in the table.
	 */
	public MethodsTableModel( MethodInfo methods[], Object data[][] ) {
		this.data  = data;
	...
	/**
	 * Returns the <code>MethodInfo</code> at the specified index.
	 */

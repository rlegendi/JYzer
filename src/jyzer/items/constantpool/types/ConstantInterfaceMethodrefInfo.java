 ...
 */
public final class ConstantInterfaceMethodrefInfo extends AbstractReference {
	 ...
	 */
	public ConstantInterfaceMethodrefInfo(DataInput di) throws IOException {
		super(di, CONSTANT_InterfaceMethodref);
	}

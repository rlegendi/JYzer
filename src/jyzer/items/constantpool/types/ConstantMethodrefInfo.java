 ...
 */
public final class ConstantMethodrefInfo extends AbstractReference {
	 ...
	 */
	public ConstantMethodrefInfo(DataInput di) throws IOException {
		super(di, CONSTANT_Methodref);
	}

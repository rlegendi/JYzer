...
/**
 * The onliest subclass of ParsingException, but is out-of-order yet.
 * I've declared it deprecated, 'cause it's non-functioning yet.
 *
...
public class ValidationException extends ParsingException {
	 ...
	 */
	public ValidationException(String where, String message) {
		super(where, message);
	}
	...
	public String getMessage() {
		return "A validation error has occured in " + where + ".\n" + message;
	}
